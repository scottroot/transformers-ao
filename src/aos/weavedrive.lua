--[[
  WeaveDrive Client
  https://github.com/permaweb/aos/blob/d57c664fcbce54ea2adba69bcb81510d19a00949/extensions/weavedrive/client/main.lua
]]
...
function drive.hello(txId)
  println(txId)
  println("Hello from weavedrive")
